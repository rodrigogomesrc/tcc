...
def gerar_dados(num_linhas):
    ...
    for _ in range(num_linhas):
        ...
        if (diff_12 > 0.35 or diff_13 > 0.35 or diff_23 > 0.35):
            label = 'HIGH'

        elif (diff_12 > 0.2 or diff_13 > 0.2 or diff_23 > 0.2):
            label = 'LOW'
...
def salvar_csv(dados, nome_arquivo="../data/dados_corrente_multiclass.csv"):
